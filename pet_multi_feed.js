...
(function () {
  ...
  const petImgs = {
    ...
    happy: new Image(),
    disgust: new Image(),
    yellowgummybearfreeze: new Image(),
    spicy: new Image(),
  };
  petImgs.normal.src = "base.png";
  petImgs.happy.src = "base_happy.png";
  petImgs.disgust.src = "base_disgust.png";
  petImgs.yellowgummybearfreeze.src = "base_yellowgummybearfreeze.png";
  ...
  const spawnMap = {
    jelly: { name: "jelly", imgSrc: "food1.png", liked: true, w: 100, h: 100, type: "normal" },
    bittergummybear: { name: "bittergummybear", imgSrc: "food2.png", liked: false, w: 100, h: 100, type: "normal" },
    pinkgummybear: { name: "pinkgummybear", imgSrc: "food3.png", liked: true, w: 100, h: 100, type: "normal" },
    yellowgummybear: { name: "yellowgummybear", imgSrc: "food4.png", liked: true, w: 100, h: 100, type: "normal" },
    icegummybear: { name: "icegummybear", imgSrc: "food5.png", liked: true, w: 120, h: 120, type: "normal" },
    giantgummybear: { name: "giantgummybear", imgSrc: "food6.png", liked: true, w: 500, h: 500, type: "normal" },
  rainbowgummybear: { name: "rainbowgummybear", imgSrc: "food7.png", liked: true, w: 120, h: 150, type: "normal" },
  ...
  function checkCollision(f) {
    ...
    if (f.type === "ice") {
      ...
      if (f.name === "Rubber icegummybear") playQuack();
  ...
  if (!spawnButtons) {
    ...
    spawnButtons.innerHTML = `
      <button id="spawnjelly"> jelly</button>
      <button id="spawnbittergummybear"> bittergummybear</button>
      <button id="spawnpinkgummybear"> pinkgummybear</button>
      <button id="spawnyellowgummybear"> yellowgummybear</button>
      <button id="spawnicegummybear"> icegummybear</button>
      <button id="spawngiantgummybear"> giantgummybear</button>
	  <button id="spawnrainbowgummybear"> rainbowgummybear</button>
  ...
  const btnMap = {
    spawnjelly: "jelly",
    spawnbittergummybear: "bittergummybear",
    spawnyellowgummybear: "yellowgummybear",
    spawnpinkgummybear: "pinkgummybear",
    spawnicegummybear: "icegummybear",
    spawngiantgummybear: "giantgummybear",
spawnrainbowgummybear: "rainbowgummybear",
  };
